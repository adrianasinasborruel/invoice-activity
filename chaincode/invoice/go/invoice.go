...
type Invoice struct {
	...
	PaidAmount      string `json:"paidamoung"`
...
func (s *SmartContract) Invoke(APIstub shim.ChaincodeStubInterface) sc.Response {
	...
	} else if function == "paidToSupplier" {
		return s.paidToSupplier(APIstub, args)
	} else if function == "repaidTheBank" {
		return s.repaidTheBank(APIstub, args)
...
// 	return s.goodsReceived(APIstub, args)
// } else if function == "paidToSupplier" {
// 	return s.paidToSupplier(APIstub)
// } else if function == "repaidTheBank" {
// 	return s.repaidTheBank(APIstub, args)
// }
...
func (s *SmartContract) repaidTheBank(APIstub shim.ChaincodeStubInterface, args []string) sc.Response {
	if len(args) != 2 {
		return shim.Error("Incorrect number of arguments. Expecting 2")
	}
