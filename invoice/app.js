...
member_user = user_from_store;
  ...
  var username = req.body.username;
  res.json(username + " us not registered to this network (registerUser.js)")
  throw new Error(username+ " is not registered to this network (registerUser.js)");
}
...
if (req.method == "POST")
{
  ...
  if(username != "IBM"){
    ...
    throw new Error(username + "is not allowed to do this transaaction");
  }
...
else if(req.method == "PUT")
{
    if(gr)    
    {
        ...
        if(username != "Lotus"){
          res.json(username + " is not allowed to do this transaction");
          throw new Error(username + " us not allowed to do this transaction");
        }
        else{
